...
const ALL_ITEMS = [
    { id: 'theme-cyberpunk', name: 'Cyberpunk 2077', type: 'theme', value: 'cyberpunk', price: 400, icon: '🌃', description: 'High-contrast neon cyan and magenta with grid aesthetics.', rarity: 'Legendary' },
...
const Inventory = () => {
    ...
    const { theme, equippedBorder, equippedTitle, equippedBadge, equipItem, unequipItem } = useTheme();
    ...
    const isEquipped = (item) => {
        ...
        if (item.type === 'badge') return equippedBadge === item.value;
        return false;
    };
